...
Gem::Specification.new do |spec|
  gem_version = '0.1.0'
  semver      = '0.1.0'
  repo_url    = 'https://github.com/iro-lib/iro-chromaticity-rb'
  home_url    = 'https://iro-lib.com'

  spec.name        = 'iro-chromaticity'
  ...
  spec.summary     = 'iro-chromaticity'
  spec.description = 'iro-chromaticity description'
